...
class NetR_Single(nn.Module):
    ...
    def forward(self, ir,rgb):
        ...
        reg_term = reg_term_ir
        return ir_warp_m,ir_grid, reg_term
        
        
class SingleBFlownet(nn.Module):
    
    def __init__(self,n_downs):
        super(SingleBFlownet,self).__init__()
